...
function updateBackToTopVisibility(){if(elements.backToTopButton){const pageIsScrollable=document.documentElement.scrollHeight>window.innerHeight+160;elements.backToTopButton.hidden=!(pageIsScrollable&&window.scrollY>420);}}
